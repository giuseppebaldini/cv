...
{Set up \code{Android} side of the \code{React Native} mobile app bringing app to feature parity with iOS}
{Configured build variants and \code{CodePush} for Android to allow for dynamic updates}
