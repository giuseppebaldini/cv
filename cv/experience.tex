...
{Worked on the \code{Android} side of the \code{React Native} mobile app bringing app to feature parity with iOS}
{Fixed bugs in both UI (e.g. splash screen, fonts) and UX (e.g. \code{Plaid} Link OAuth flow, navigation deep links)}
{Improved development (build variants) and deployment (\code{CodePush} for Android for continuous updates)}
